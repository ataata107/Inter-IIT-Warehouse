	...
	set_attitude(thrust = pidout)
        ...
        if(current_altitude>=TAltitude):
            ...
            while True:
                  ...
                  set_attitude(thrust = pidout)
                  time.sleep(0.1)
                  avg+=current_altitude
                  c+=1
                  if(c>=50 and avg>=TAltitude-0.1 and avg<=TAltitude+0.1):
                      break
            break
...
print("Move forward ")
set_attitude(pitch_angle = 1, thrust = pidout, duration = 3)

print("Move backward")
set_attitude(pitch_angle = -1, thrust = pidout, duration = 3)
print("Roll Right ")
set_attitude(roll_angle = 1, thrust = pidout, duration = 3)
